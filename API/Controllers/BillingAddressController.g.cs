...
{
    /// <summary>
    /// Controller responsible for managing billingaddress-related operations in the API.
    /// </summary>
    /// <remarks>
    ...
    public class BillingAddressController : ControllerBase
    {
        ...
        public BillingAddressController(InventorymanagementsystemContext context)
        {
            _context = context;
        }

        /// <summary>Adds a new billingaddress to the database</summary>
        ...
        public IActionResult Get([FromQuery] string filters, string searchTerm, int pageNumber = 1, int pageSize = 10, string sortField = null, string sortOrder = "asc")
        {
            ...
            var query = _context.BillingAddress.IncludeRelated().AsQueryable();
        ...
        {
            var entityData = _context.BillingAddress.IncludeRelated().FirstOrDefault(entity => entity.Id == id);
        ...
        public IActionResult DeleteById([FromRoute] Guid id)
        {
            ...
            _context.BillingAddress.Remove(entityData);
        ...
        public IActionResult UpdateById(Guid id, [FromBody] BillingAddress updatedEntity)
        {
            ...
            this._context.BillingAddress.Update(updatedEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
        ...
        public IActionResult UpdateById(Guid id, [FromBody] JsonPatchDocument<BillingAddress> updatedEntity)
        {
            ...
            var existingEntity = this._context.BillingAddress.FirstOrDefault(t => t.Id == id);
            if (existingEntity == null)
                return NotFound();
            updatedEntity.ApplyTo(existingEntity, ModelState);
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            this._context.BillingAddress.Update(existingEntity);
            var status = this._context.SaveChanges();
            return Ok(new { status });
        }
    }
